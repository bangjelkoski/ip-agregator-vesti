...
<head>
    ...
    <?php
        ...
        if(!$user || $vest['IDKorisnika'] != $user['IDKorisnika']){
          header('Location: index.php'); 
          die();
        }
        $kategorije = explode(', ', $vest['PodKategorija']);
    ?>
</head>
<body>
   <div class="wrapper">
      ...
      <!-- Pocetak Main Content -->
          <div id="main-content"">
              <div class="glavni-block glavni-sadrzaj box-shadow">
                  <div class="red">
                      <div class="kol-12">
                        <h2 class="kategorija-naslov">Vest - <?php echo $vest['Naslov']; ?></h2>
                      </div>
                      <div class="kol-12">
                      <form method="post" action="action_azuriraj_vest.php"  enctype="multipart/form-data">
                        <div class="kol-12 korisnicka-forma">
                            <div class="kol-6">
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="fa fa-envelope input-group-addon"></span>
                                        <input type="text" class="form-control" required name="naslov" value="<?php echo $vest['Naslov']; ?>" placeholder="Naslov" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="fa fa-folder input-group-addon"></span>
                                        <select class="form-control" name="kategorija[]" required multiple placeholder="Izaberi Kategoriju" id="izaberi-kategoriju">
                                ...
                                <input type="hidden" name="IDVesti" value="<?php echo $vest['IDVesti']; ?>"/>
   ...
   <script>
      $(document).ready(function(){
          $('#izaberi-kategoriju').val(<?php echo json_encode($kategorije); ?>);
      });
   </script>
</body>
</html>