...
$sql = "INSERT INTO `vesti` (`IDVesti`, `IDKorisnika`, `PodKategorija`, `Naslov`, `BrojHejtova`, `BrojLajkova`, `datum`) VALUES (NULL, '". $id_korisnika ."', '". $kat ."', '". $naslov ."', '0', '0', NULL);";
 mysqli_query($conn, $sql);


// ID Vest koji smo uneli zadnji
